      ...
      <Paper elevation={24} sx={{ height: '65vh', margin: '20px auto', width: '800px', padding: '20px', position: 'relative' }}>
        ...
        <form onSubmit={handleFormSubmit}>
          <Grid container spacing={2} sx={{ mt: 2 }}>
            <Grid item xs={12}>
              <TextField label="Applicant Name" required variant="outlined" name="applicant_name" fullWidth onChange={handleChange} />
            </Grid>
          </Grid>
          <Grid container spacing={2} sx={{ mt: 2 }}>
            <Grid item xs={12}>
              <TextField label="Applicant Email" required variant="outlined" name="applicant_email" type="email" fullWidth onChange={handleChange} />
            </Grid>
          </Grid>
          <Grid container spacing={2} sx={{ mt: 2 }}>
            <Grid item xs={6}>
              <TextField label="Resume" variant="outlined" name="resume" type="file" fullWidth onChange={handleChange} />
            </Grid>
            <Grid item xs={6}>
              <TextField label="Cover Letter" variant="outlined" name="cover_letter" type="file" fullWidth onChange={handleChange} />
            </Grid>
          </Grid>
